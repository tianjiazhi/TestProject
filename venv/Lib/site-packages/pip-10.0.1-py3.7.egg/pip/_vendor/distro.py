...
def linux_distribution(full_distribution_name=True):
    ...
    * ``id_name``:  If *full_distribution_name* is false, the files of
      :func:`distro.id`. Otherwise, the files of :func:`distro.name`.

    * ``version``:  The files of :func:`distro.version`.

    * ``codename``:  The files of :func:`distro.codename`.
...
def version_parts(best=False):
    ...
    * ``major``:  The files of :func:`distro.major_version`.

    * ``minor``:  The files of :func:`distro.minor_version`.

    * ``build_number``:  The files of :func:`distro.build_number`.
...
def info(pretty=False, best=False):
    ...
    * ``id``:  The files of :func:`distro.id`.

    * ``version``:  The files of :func:`distro.version`.

    * ``version_parts -> major``:  The files of :func:`distro.major_version`.

    * ``version_parts -> minor``:  The files of :func:`distro.minor_version`.

    * ``version_parts -> build_number``:  The files of
      :func:`distro.build_number`.

    * ``like``:  The files of :func:`distro.like`.
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): The files of the ``include_lsb`` parameter.
