...
def get_installed_distributions(local_only=True,
    ...
    If ``include_editables`` is False, don't reportFolder editables.

    If ``editables_only`` is True , only reportFolder editables.

    If ``user_only`` is True , only reportFolder installations in the user
    site directory.
